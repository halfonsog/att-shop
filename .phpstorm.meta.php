...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\att-shop\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\att-shop\\public\\storage','logging.default','logging.deprecations.channel',
...
'web','api',);
        registerArgumentsSet('routes', 'login','login.post','register','logout','products.search','product.show','cart.add',
'cart.view','cart.update','cart.remove','checkout','checkout.place',
'suppliers.index','suppliers.create','suppliers.store','suppliers.show','suppliers.commissions',
'products.index','products.store','products.manage','products.create','orders.index',
'orders.show','orders.status','commissions.index','commissions.pay','commissions.process',
'storage.local',);
